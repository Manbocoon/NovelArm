...
namespace NovelArm.Modules
{
    ...
    {
        /// <summary>
        /// 속도는 미세하게 느리지만, 새로운 객체를 복사하지 않도록 만든 StringBuilder IndexOf 함수
        /// </summary>
        ...
        /// <returns></returns>
        internal static int IndexOf(StringBuilder stringBuilder, string value, int startIndex = 0, bool ignoreCase = false)
        {
        ...
        /// <summary>
        /// 특정 단어가 나오는 구간의 데이터를 모두 삭제하여 업데이트합니다.
        /// </summary>
        ...
        /// <param name="ignoreCase">True: 대소문자 검사를 무시합니다.</param>
        internal static void Remove(ref StringBuilder stringBuilder, string value, byte removeType = 0, bool ignoreCase = false)
        {
            int valueIndex = IndexOf(stringBuilder, value, 0, ignoreCase);
